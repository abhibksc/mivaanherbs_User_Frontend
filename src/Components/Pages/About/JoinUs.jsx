...
const products = [
  ...
  },
  {
    ...
    insurance: "₹1,00,000 Insurance Included", // ✅ Added insurance key
  },
];
    ...
    <div className="bg-gray-50 py-10 px-4 md:px-10">
      <div className="text-center mb-10">
        <h1 className="text-3xl md:text-4xl font-bold text-green-700">
          Join Our Network Marketing Revolution
        </h1>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
          Discover your path to financial freedom and wellness. Our unique
          products and proven business model help thousands build a better life.
        </p>
      </div>
      ...
      <div className="bg-white shadow-lg p-8 rounded-2xl max-w-4xl mx-auto">
        ...
        <p className="text-gray-700 leading-relaxed">
          In a world where job security is no longer guaranteed, network
          marketing has emerged as a powerful tool for individuals to take
          control of their income. By joining our mission, you get access to
          high-quality herbal and wellness products, a dedicated support system,
          and training modules that guide you to success.
        </p>
